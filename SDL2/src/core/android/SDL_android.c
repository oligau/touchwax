...
void Java_org_libsdl_app_SDLActivity_nativeQuit(
                                    JNIEnv* env, jclass cls)
{
    /* Discard previous events. The user should have handled state storage in SDL_APP_WILLENTERBACKGROUND.
     * After nativeQuit() is called, no events other than SDL_QUIT and SDL_APP_TERMINATING should fire */
